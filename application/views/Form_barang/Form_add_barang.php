                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-alternative" name="namabarang" placeholder="Nama  Barang" value="" type="text">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" min="1" class="form-control form-control-alternative" name="jumlah">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" min="1" class="form-control form-control-alternative" name="harga">
                            </div>
                        </div>
                    </div>
