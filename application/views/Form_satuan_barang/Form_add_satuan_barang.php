<div class="col">
  <div class="card shadow">
    <div class="card-header border-0">
      <form name="fromaddsatuanbarang" action="<?= base_url('Controller_satuanbarang/Controller_satuanbarang/addsatuanbarang') ?>" method="post">
        <h6 class="heading-small text-muted mb-4">Add Satuan</h6>
        <hr class="my-4" />
        <div class="pl-lg-4">
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <input id="input-address" class="form-control form-control-alternative" name="nameSatuan" placeholder="Name Satuan" value="" type="text">
              </div>
              <div class="form-group">
                <label class="form-control-label" for="input-address">Nilai Satuan</label>
                <input id="input-address" class="form-control form-control-alternative" name="nilai" placeholder="Nilai" value="" type="number">
              </div>
            </div>
          </div>
