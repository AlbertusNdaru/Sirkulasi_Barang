    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-primary shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div align="center" class="col mr-2">
              <div class="text-l font-weight-bold text-primary text-uppercase mb-1">Total Transaksi Barang Rusak</div>
              <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $barangrusak->BR?> (Transaksi)</div>
            </div>
            <div class="col-auto">
              <!-- <i class="fas fa-dollar-sign fa-2x text-gray-300"></i> -->
            </div>
