...
class Model_report extends CI_Model
{
    ...
    {
        $this->db->select('a.*, b.Name as NamaBarang, c.Name as NamaTipe, b.id_tipe_barang, d.Name as NamaSatuan');
    ...
    {
        $this->db->select('a.*, b.Name as NamaBarang, c.Name as NamaBagian, b.id_tipe_barang, d.Name as NamaSatuan');
