...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 13, 2019 at 09:41 AM
...
(7, 'BRG005', 9, 2000, '2019-12-13', NULL);
...
(6, 'Sansen', 'L', 'Gunungkidul', 'Farishy@gmail.com', 'Aktif', '2019-12-13 14:34:30', '2019-12-13 14:55:42'),
(7, 'Fiko', 'L', 'Yogyakarta', 'fiko@gmail.com', 'Aktif', '2019-12-13 14:59:16', NULL);
...
('TIPE002', 'ENUMxxxx', '2019-12-09 15:31:56', '2019-12-12 09:54:01');
...
(6, 6, 2, 'Coba', '12345', NULL, '2019-12-13 07:46:50', '2019-12-13 14:43:44', 'Aprove'),
(7, 7, 2, 'fiko', '12345', NULL, '2019-12-13 07:59:16', NULL, 'NotAprove');
...
--
ALTER TABLE `tb_barang_masuk`
  MODIFY `id_barang_masuk` smallint(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `tb_operator`
  MODIFY `id_operator` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `tb_user`
--
ALTER TABLE `tb_user`
  MODIFY `id_user` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
